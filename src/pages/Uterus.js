...
const Uterus = () => {
 ...
 <div className="question">
  ...
  <label><input type="radio" name="q3" onChange={() => handleAnswerChange(2, 0)} /> Always regular (0 points)</label>
  <label><input type="radio" name="q3" onChange={() => handleAnswerChange(2, 2)} /> Mostly regular (2 points)</label>
  <label><input type="radio" name="q3" onChange={() => handleAnswerChange(2, 4)} /> Occasionally irregular (4 points)</label>
  <label><input type="radio" name="q3" onChange={() => handleAnswerChange(2, 6)} /> Frequently irregular (6 points)</label>
 </div>
